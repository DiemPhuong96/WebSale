...
<body>
	<div class="row">
		<c:forEach items="${listNewProduct}" var="list">
				...
				<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
					...
					<div class="block2">
						...
						<div class="block2-txt p-t-20">
							<a href="DetailProduct?productId=${list.productId}"
								class="block2-name dis-block s-text3 p-b-5">
								${list.productName} </a> <span class="block2-oldprice m-text7 p-r-5">
								${list.price} </span> <span class="block2-newprice m-text8 p-r-5">
