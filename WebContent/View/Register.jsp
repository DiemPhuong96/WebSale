...
<script type="text/javascript">
			function validate(){
				...
				var repeatPassword = document.formregister.repeatPassword.value;
				...
				if(email == ""|| phone=="" || name == "" || password=="" || repeatPassword == ""){
					...
					if(password.length<= 6){
						document.getElementById("errorpasword").innerHTML ="Lenght of password must > 6"
							return false;
					}
					else if(password !== repeatPassword){
						document.getElementById("errorpasword").innerHTML ="Repeat password is wrong"
							return false;
					}
										...
										<form action="LoginForward" method="post">
											<fieldset>
												<label class="block clearfix"> <span
													...
													style="color: red"> <%=request.getAttribute("msgRegister") != null? request.getAttribute("msgRegister"): "" %>

												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" class="form-control" placeholder="Email"
														name="email" /> <i class="ace-icon fa fa-user"></i>
												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<form action="RegisterForward" method="post"
											name="formregister" onsubmit="return validate()">
											<fieldset>

												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="email" class="form-control" placeholder="Email"
														name="email" /> <i class="ace-icon fa fa-envelope"></i>
												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="phone" class="form-control"
														placeholder="Number Phone" name="phone" /> <i
														class="ace-icon fa fa-phone"></i>
												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" class="form-control" placeholder="Username"
														name="name" /> <i class="ace-icon fa fa-user"></i>
												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="password" class="form-control"
													...
													class="block input-icon input-icon-right"> <input
														type="password" class="form-control"
														placeholder="Repeat password" name="repeatPassword" /> <i
														class="ace-icon fa fa-retweet"></i>
												</span>
												</label> <label class="block clearfix" id="errorpasword"> </label> <label
													class="block"> <input type="checkbox" class="ace" />
													<span class="lbl"> I accept the <a
														href="LoginForward">User Agreement</a>
												</span>
												</label>
