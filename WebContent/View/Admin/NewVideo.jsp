			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li><a href="#">Show</a></li>
						<li class="active">New avatar for video</li>
					</ul>
					<!-- /.breadcrumb -->
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form name="myform" action="VideoController" method="post"
								enctype="multipart/form-data" onsubmit="return inserLink()">
								<label class="block clearfix"> <%=request.getAttribute("videomsg")!=null?request.getAttribute("videomsg"):" "%>
								</label>

								<div id="validate" style="color: red"></div>
								<br> <br> choose image <input name="files" type="file">
