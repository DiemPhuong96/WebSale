...
<body>
	<div class="navbar-container ace-save-state" id="navbar-container">
		<div class="navbar-header pull-left">
			<a href="HomeController" class="navbar-brand"> <small> <i
					class="fa fa-leaf"></i> My Web
			</small>
			</a>
		</div>
		<div class="navbar-buttons navbar-header pull-right" role="navigation">
			<ul class="nav ace-nav">
				<li class="grey dropdown-modal"></li>
						...
						<li class="dropdown-content">
							<ul class="dropdown-menu dropdown-navbar">
								...
								<li><a href="#" class="clearfix"> <img
										...
										alt="Kate's Avatar" /> <span class="msg-body">F <span
				...
				<li class="light-blue dropdown-modal"><a data-toggle="dropdown"
					href="#" class="dropdown-toggle"> <img class="nav-user-photo"
						src="Template/Backend/assets/images/avatars/admin_icon.png"
