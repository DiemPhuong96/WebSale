...
<script type="text/javascript">
		function inserLink(){
			var link = document.myform.video.value;
			if(link == ''){
						...
						<div class="col-xs-12">
							<div>
								<ul class="ace-thumbnails clearfix">
									...
									<center>
										<a href="Template/Backend/assets/images/admin.jpg"
											title="Photo Title" data-rel="colorbox"> <img width="400"
											height="400" alt="400x400"
											src="Template/Backend/assets/images/admin.jpg"
