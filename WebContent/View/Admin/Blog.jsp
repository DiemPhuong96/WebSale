...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li><a href="ProductsForward?pageid=1">Blog</a></li>
										...
										<table id="simple-table"
											...
											<tbody>
												...
												<c:forEach items="${listBlog}" var="list">
													<tr>
														<td class="center">${list.blogId}</td>
														<td class="center">${list.name}</td>

														<td class="center">${list.image}</td>
														<td class="center">${list.meta}</td>

														<td class="center"><a class="red"
															href="DeleteBlog?blogId=${list.blogId}"> <i
	...
	<div class="modal fade" id="myModal" role="dialog">
		<div class="modal-dialog">
			<!-- Modal content-->
			<form action="TitleOfBlogForward" method="post">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title">Insert title and choose category</h4>
					</div>
									...
									<div>
										<label for="form-field-select-3">Category</label> <br /> <select
											...
											<c:forEach items="${listCategoryforblog}" var="list">
												<option value="${list.categoryForBlogId}">${list.name}</option>

											</c:forEach>
										</select> <label for="form-field-select-3">Title</label> <input
											type="text" id="form-field-select-3"
											placeholder="Insert title" t
											class="chosen-select form-control" name="title" />
