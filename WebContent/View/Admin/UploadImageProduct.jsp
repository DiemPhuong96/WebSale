				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="UploadImageProducts?productId=${productId}"
								method="post" enctype="multipart/form-data">
								<label class="block clearfix"> <%=request.getAttribute("productMsg")!=null?request.getAttribute("productMsg"):" "%>
								</label>
								...
								<div class="clearfix">
									...
									<input type="submit" value="Submit"
										class="btn btn-sm btn-primary"> <input id="addFile"
										type="button" value="Add file" class="btn btn-sm btn-primary" />
