...
<title>Change product of the banner</title>
<link rel="stylesheet"
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="widget-body">
											<form
												action="ChangeBannerForward?bannerId=<%= request.getAttribute("bannerId")%>"
												method="post">
												<div class="widget-main" style="width: 500px;">
													<div class="col-sm-9">
														<input type="text" id="form-field-1-1"
															placeholder="Name of banner" class="form-control"
															name="name" />
													</div>
